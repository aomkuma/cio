<?php
	...
	$content = file_get_contents('http://motstesting.webstarterz.com/cio/services/public/news/rss/');
	...
	foreach ($rss as $key => $value) {
		...
		echo "			<link>http://motstesting.webstarterz.com/cio/#/news/detail/" . $value['id'] . "</link>".PHP_EOL;;
